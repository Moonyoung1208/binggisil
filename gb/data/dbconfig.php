...
define('G5_MYSQL_USER', 'binggisil');
define('G5_MYSQL_PASSWORD', 'sej0330!');
define('G5_MYSQL_DB', 'binggisil');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '57878965106bef94cc386842814dac63'); // 토큰 암호화에 사용할 키
