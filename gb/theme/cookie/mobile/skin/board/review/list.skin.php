...
<div class="sub">
    ...
    <div class="sub-address">
        <ul class="address-wrap">
            ...
            <li><a href="javascript:void(0)" class="menu">커뮤니티</a>
                <ul class="address-wrap-sub">
                    <li><a href="">빙기실 치유마을 소개</a></li>
                    <li><a href="">달빛고운 병곡 캠핑장 소개</a></li>
                    <li><a href="">이용안내</a></li>
                    <li><a href="">예약안내</a></li>
                    <li><a href="">체험안내</a></li>
            ...
            <li><a href="javascript:void(0)" class="menu border-none">이용 후기</a>
                <ul class="address-wrap-sub">
    ...
    <div class="sub-main-wrap">
        <div class="sub-main-left">
            <div class="sub-main-nav">
                ...
                <ul>
                    <li><a href="/gb/bbs/board.php?bo_table=notice">공지사항<i class="xi-angle-right"></i></a></li>
                    <li><a href="/gb/bbs/board.php?bo_table=review" class="point">이용 후기<i class="xi-angle-right"></i></a></li>
                    <li><a href="/gb/bbs/board.php?bo_table=qa">Q&A<i class="xi-angle-right"></i></a></li>
                </ul>
            </div>
