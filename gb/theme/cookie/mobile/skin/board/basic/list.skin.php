...
<div class="sub">
    ...
    <div class="sub-address">
        <ul class="address-wrap">
            ...
            <li><a href="javascript:void(0)" class="menu border-none">공지사항</a>
                <ul class="address-wrap-sub">
    ...
    <div class="sub-main-wrap">
        <div class="sub-main-left">
            <div class="sub-main-nav">
                ...
                <ul>
                    <li><a href="/gb/bbs/board.php?bo_table=notice" class="point">공지사항<i class="xi-angle-right"></i></a></li>
                    <li><a href="/gb/bbs/board.php?bo_table=review">이용 후기<i class="xi-angle-right"></i></a></li>
