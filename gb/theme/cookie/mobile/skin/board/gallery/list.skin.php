...
<div class="sub">
    ...
    <div class="sub-address">
        <ul class="address-wrap">
            <li><a href="https://binggisil.mycafe24.com/" class="home"><i class="xi-home"></i></a></li>
            <li><a href="javascript:void(0)" class="menu">체험안내</a>
                <ul class="address-wrap-sub">
                    ...
                    <li><a href="">농산물안내</a></li>
                    <li><a href="/gb/bbs/board.php?bo_table=notice">커뮤니티</a></li>
                </ul>
            </li>
            <li><a href="javascript:void(0)" class="menu border-none">힐링 체험안내</a>
                <ul class="address-wrap-sub">
                    <li><a href="../cure/cure.html">치유 프로그램</a></li>
                    <li><a href="../program.html">프로그램 신청안내</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <link rel="stylesheet" href="../../css/sub01/facilities.css">
    <link rel="stylesheet" href="../../css/sub02/sub02.css">
    ...
    <div class="sub-main-wrap">
        <div class="sub-main-left">
            <div class="sub-main-nav">
                ...
                <ul class="pc-nav">
                    <li><a href="https://binggisil.mycafe24.com/sub05/cure/cure.html">치유프로그램<i class="xi-angle-right"></i></a></li>
                    <li><a href="https://binggisil.mycafe24.com/sub05/healing/healing.html"  class="point">힐링 체험안내<i class="xi-angle-right"></i></a>
                        <ul class="address-wrap-sub-num">
                            <li><a href="https://binggisil.mycafe24.com/sub05/healing/healing.html">힐링 프로그램</a></li>
                            <li><a href="/gb/bbs/board.php?bo_table=gallery" class="point02">힐링 갤러리</a></li>
                        </ul>
                    </li>
                    <li><a href="https://binggisil.mycafe24.com/sub05/program.html">프로그램 신청안내<i class="xi-angle-right"></i></a></li>
                </ul>
        ...
        <div class="sub_contents">
            <div class="title-text">
                <h1>힐링 프로그램</h1>
                <p>다양한 체험과 연계된 숙박시설,<br class="mobile"> 빙기실치유마을에 오신 것을 환영합니다!</p>
            </div>
